...
import { inDiseaseGrace } from './calendar.ts';
import { defaultJobHoles, isHoleModel, mapHoleSurfaces } from './holes.ts';
import { isAboveBand } from './moisture.ts';
import { diseaseRiskMult } from './grass.ts';
