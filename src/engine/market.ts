...
import { getMachine, MACHINES } from '../data/equipment.ts';
import { bumpCapitalSpent } from './history.ts';
import { clampCondition, conditionOf, dropOwnedMachine, ensureAutoWeek, recomputePlannedMinutes, stampOwnedMachine } from './equipment.ts';
import { cashOnHand, needsCapital, spendCapital } from './cash.ts';
...
export function canBuyUsed(state, listingId): any {
