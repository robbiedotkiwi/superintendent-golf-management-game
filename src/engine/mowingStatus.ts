...
import { surfaceCeiling } from './equipment.ts';
import { grassGrowthFactor, hocRangeFor } from './grass.ts';
import { courseSettings, holeKind, meanQuality, presentHoles } from './holes.ts';
import { daysSinceLastWorked, isNeglected } from './neglect.ts';
import { hasPattern } from './mowing.ts';
