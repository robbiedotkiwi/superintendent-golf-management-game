...
import { PER_HOLE_MINUTES } from './courseArea.ts';
import { hocFactor, patternTimeMult } from './mowing.ts';
import { hocRangeFor } from './grass.ts';
import { defaultJobHoles, formatHoleSet, sameHoleSet } from './holes.ts';
import { getDayTasks, planningDayOf } from './week.ts';
