...
import { clampQuality } from './grades.ts';
import { inHocStressBand } from './mowing.ts';
import { areaGradeCap, emptyAreaQuality, growInOffset, passesRequired, weeklyPassRatio, weeklyTargetQuality } from './passes.ts';
import { courseSettings } from './holes.ts';
