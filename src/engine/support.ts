...
import { layoutHasBunker, holeCount } from './holes.ts';
import { forecastEntryForDay } from './week.ts';
import { clampQuality } from './grades.ts';
import { hoursToMinutes, roundDurationHours } from './duration.ts';
import { emptyAreaQuality } from './passes.ts';
