...
import { migrateMachineMaps, normalizeMachineOverride } from './equipment.ts';
import { canonicalMachineId } from '../data/equipment.ts';
import { emptyYearRecord } from './history.ts';
import { emptyDaysSinceWorked } from './mail.ts';
import { createInitialHoles, createSurfaceDefaults, fanGroupedToHoles, isHoleModel, stampTreatmentsFromTypeWide } from './holes.ts';
import { migrateMoisture } from './moisture.ts';
import { clampHoc } from './mowing.ts';
import { createRng } from './rng.ts';
import { applyTempsForWeather, buildForecast, canonicalWeather, tempsFromLegacyHeat } from './weather.ts';
import { normalizeSection, normalizeTabs } from './section.ts';
import { allGmSeen, allSectionUnlocks } from './gm.ts';
import { generateCasuals } from '../data/staff.ts';
import { migrateVolunteerWeekday, migrateVolunteerWorker } from './staff.ts';
import { emptyWeekPlan, weekStartDay } from './week.ts';
import { snapshotWeekStart } from './weekReview.ts';
import { migrateIrrigation } from './irrigation.ts';
import { hocRangeFor, normalizeGrass } from './grass.ts';
import { migrateWorkerTier } from './staffTiers.ts';
import { emptyAreaQuality, emptyWeekPassState, applyAreaQualityToHoles } from './passes.ts';
import { CAPEX_STATUS_PENDING, STARTING_CAPEX, STARTING_MONTHLY_BUDGET } from '../data/config.ts';
