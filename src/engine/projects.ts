...
import { conversionTargets, grassById, grassIdFor, speciesAllowedOn } from './grass.ts';
import { expandHoleRecords, holeCount, mapHoleSurfaces } from './holes.ts';
import { clampHoc } from './mowing.ts';
import { needsCapital, spendCapital } from './cash.ts';
import { emptyMoisture, emptyMoistureReadDay } from './moisture.ts';
...
export function canStartProject(state, id, workerId = PLAYER_ID): any {
