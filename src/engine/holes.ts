...
import { HOLE_SHAPES } from '../data/courseLayout.ts';
import { holesForCount } from '../data/course.ts';
import { hocRangeFor } from './grass.ts';
...
function createBunkerRecord({ quality, lastRakedDay = STARTING_DAY } = {} as any) {
...
export function createInitialHoles(count = HOLE_COUNT, extras: any = {}) {
...
export function stampTreatmentsFromTypeWide(holes, sprayedUntil: any = {}, fertiliserUntil: any = {}) {
