import { FORECAST_FUEL_LOOKBACK_DAYS, POND_DOSE_COST, POND_DOSE_WEEK_DAYS, POND_DOSING_LABEL } from '../data/constants.ts';
import { getMachine } from '../data/equipment.ts';
import { leaseCost, seasonGrant } from './budget.ts';
import { daysUntilSeasonEnd, seasonEndDay } from './calendar.ts';
import { cashOnHand } from './cash.ts';
import { wageBill } from './staff.ts';
import { daysSincePondDose } from './irrigation.ts';
import { weekDays, weekPlanOf } from './week.ts';
