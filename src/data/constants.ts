...
export const HOLE_NUMBER_RADIUS = 50;
export const HOLE_NUMBER_FONT = 96;
...
export const DOGLEG_MIN_HOLES = 0;
...
export const VOLUNTEER_SPEED_SKILL = PLAYER_SPEED_SKILL;
export const VOLUNTEER_QUALITY_SKILL = PLAYER_QUALITY_SKILL;
...
export const CASUAL_OWN_MOWER_VS_CASUAL = 1.5;
export const CASUAL_OWN_MOWER_WAGE_MULT = CASUAL_WAGE_MULT * CASUAL_OWN_MOWER_VS_CASUAL;
...
export const FUEL_BURN_L_PER_HOUR = {
  ...
  [MACHINE_CLASS_RIDING_GREENS_TRIPLEX]: 4.5,
...
export const PROJECT_GRASS_CONVERSION = 'grassConversion';
...
export const GRASS_CONVERSION_DAILY_MINUTES = 40;
export const GRASS_CONVERSION_QUALITY_HIT = 10;
export const GRASS_CONVERSION_COST = {
  greens: 35000,
  tees: 12000,
  fairways: 22000,
  rough: 8000,
};
export const GRASS_CONVERSION_DAYS = {
  greens: 18,
  tees: 10,
  fairways: 14,
  rough: 8,
...
export const TURF_TAB_BUNKERS = TURF_TAB_WEEK;
export const TURF_TAB_POND = TURF_TAB_IRRIGATION;
export const TURF_SHOW_LEGACY_TABS = false;
export const TURF_TABS = [TURF_TAB_WEEK, TURF_TAB_IRRIGATION, TURF_TAB_PATTERNS];
export const TURF_PRIMARY_TABS = [TURF_TAB_WEEK, TURF_TAB_IRRIGATION, TURF_TAB_PATTERNS];
export const TURF_TAB_DEFAULT = TURF_TAB_WEEK;
...
export const PROJECT_REASON = (name) => `${name} — on site work`;
