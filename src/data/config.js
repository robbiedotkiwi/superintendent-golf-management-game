...
export const SLOT_MINUTES = HOUR_INCREMENT * MINUTES_PER_HOUR;
export const WORK_DAY_MINUTES = WORK_DAY_HOURS * MINUTES_PER_HOUR;
...
export const BUNKER_HOURS_EACH = 0.5;
export const CUP_CHANGE_HOURS = 2;
export const MOISTURE_METER_HOURS = 2;
export const ROLL_GREENS_HOURS = 3;
export const WEED_EATING_HOURS = 4;
export const GM_MEETING_HOURS = 1;
export const GENERAL_DUTIES_HOURS = 5;
export const GENERAL_DUTIES_HOURS_MIN = 4;
export const GENERAL_DUTIES_HOURS_MAX = 6;
export const SPRAY_GREENS_TEES_HOURS = 4;
export const SPRAY_FAIRWAYS_HOURS = 8;
export const CORING_HOURS = 16;
export const BUNKER_MINUTES_EACH = BUNKER_HOURS_EACH * MINUTES_PER_HOUR;
export const CUP_CHANGE_MINUTES = CUP_CHANGE_HOURS * MINUTES_PER_HOUR;
export const MOISTURE_METER_MINUTES = MOISTURE_METER_HOURS * MINUTES_PER_HOUR;
export const ROLL_GREENS_MINUTES = ROLL_GREENS_HOURS * MINUTES_PER_HOUR;
export const WEED_EATING_MINUTES = WEED_EATING_HOURS * MINUTES_PER_HOUR;
export const GM_MEETING_MINUTES = GM_MEETING_HOURS * MINUTES_PER_HOUR;
export const GENERAL_DUTIES_MINUTES = GENERAL_DUTIES_HOURS * MINUTES_PER_HOUR;
export const GENERAL_DUTIES_SKIP_WEEKS_FOR_COMMENT = 3;
export const SPRAY_GREENS_TEES_MINUTES = SPRAY_GREENS_TEES_HOURS * MINUTES_PER_HOUR;
export const SPRAY_FAIRWAYS_MINUTES = SPRAY_FAIRWAYS_HOURS * MINUTES_PER_HOUR;
export const SPRAY_WIND_MAX = 18;
export const SPRAY_RAIN_CLEAR_HOURS = 6;
export const CORING_MINUTES = CORING_HOURS * MINUTES_PER_HOUR;
...
export const MONTHLY_GOLFERS_BASE = 50;
export const MONTHLY_GOLFERS_PER_QUALITY = 2;
export const MONTHLY_GOLFERS_PER_HOLE = 6;
export const SEASON_CAPEX_BASE = 25000;
export const SEASON_1_CAPEX_WEEK = 3;
...
export const EXPAND_HOLE_COUNT_3 = 3;
export const EXPAND_HOLE_COUNT_9 = 9;
...
export const GENERAL_DUTIES_MINUTES_MIN = GENERAL_DUTIES_HOURS_MIN * MINUTES_PER_HOUR;
export const GENERAL_DUTIES_MINUTES_MAX = GENERAL_DUTIES_HOURS_MAX * MINUTES_PER_HOUR;
