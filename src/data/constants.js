...
export const POND_CX = 400;
export const POND_CY = 310;
...
export const FLAG_POLE = 22;
export const FLAG_WIDTH = 10;
export const FLAG_HEIGHT = 8;
export const TEE_MARKER_OFFSET = 18;
...
export const RANGE_X = 520;
export const RANGE_Y = 600;
