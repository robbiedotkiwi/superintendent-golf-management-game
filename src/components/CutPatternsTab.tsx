...
import { BASELINE_MOW_FREQUENCY_PER_WEEK } from '../data/grass.ts';
import { courseSettings } from '../engine/holes.ts';
import { hasHoc, hasPattern, inHocStressBand } from '../engine/mowing.ts';
import { grassSpeciesFor, hocRangeFor, isGrassDormant } from '../engine/grass.ts';
