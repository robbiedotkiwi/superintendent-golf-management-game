...
import { golferNumbers, gmRequiredGrade, meanPassQuality, monthlyBudgetFor, monthsUntilNextCapex } from '../engine/economy.ts';
import { weekOfSeason } from '../engine/calendar.ts';
import { coringWindowOk, sprayWindowOk } from '../engine/support.ts';
import { daysUntilNextTournament, nextTournament } from '../engine/tournament.ts';
import { gradeLetter } from '../engine/grades.ts';
