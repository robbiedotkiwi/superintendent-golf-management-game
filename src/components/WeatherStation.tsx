import { WEATHER_STATION_COST } from '../data/constants.ts';
...
import { IRRIGATED_SURFACES } from '../engine/irrigation.ts';
import { surfaceEtMm } from '../engine/moisture.ts';
import { canBuyWeatherStation, formatTempRange, stationAtmosphere } from '../engine/weather.ts';
