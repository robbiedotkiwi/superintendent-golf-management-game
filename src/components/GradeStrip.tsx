import { PASS_AREAS } from '../data/config.ts';
import { SURFACE_LABELS } from '../data/tasks.ts';
import { gradeLetter, gradeTrend } from '../engine/grades.ts';
import { bestMachineCap } from '../engine/passes.ts';
import { projectedWeeklyGrade } from '../engine/weekPasses.ts';
