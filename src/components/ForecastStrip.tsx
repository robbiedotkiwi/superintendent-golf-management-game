...
import { WET_PASS_TIME_MULT, WET_WEATHER } from '../data/config.ts';
import { WEATHER_LABELS } from '../data/events.ts';
import { forecastIsUnreliable, forecastOpacity, formatTempRange } from '../engine/weather.ts';
import {
  canEditPlanDay,
  forecastEntryForDay,
  getDayTasks,
...
export default function ForecastStrip({ state, onSelectDay = undefined, selectedDay = undefined }) {
