...
import { MACHINES, getMachine } from '../data/equipment.ts';
import { upgradesForMachine } from '../data/upgrades.ts';
import { canLeaseMachine, leaseCost } from '../engine/budget.ts';
...
import { canBuyUsed, canSellMachine, salePrice } from '../engine/market.ts';
